...
function Navbar() {
  return (
    <nav className="flex  w-full md:w-[90%] min-h-[50px] items-center justify-between py-5 md:py-[100px] md:px-[50px] m-5 px-[10px] mx-auto z-[1] overflow-hidden">
        <div className="font-poppins md:text-[3rem] text-[2.5rem]">Adi.</div>
