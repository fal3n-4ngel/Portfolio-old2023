...
export default function Home() {
  return (
    <main className="items-center justify-center overflow-x-hidden">
      ...
      <div className="min-h-[90vh]  mt-16 flex md:hidden font-light text-4xl md:text-7xl leading-[5rem] tracking-[0px] w-full md:px-[18%] px-[7%] py-[20%] items-center">
        <RevealText>
          <div>I&apos;m Adi - a Versatile</div>
          <div>Developer adept in the realms of</div>
          <div>  Web, App dev and Scripting</div>
          <div> </div>
        </RevealText>
      </div>
